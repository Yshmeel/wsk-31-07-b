    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                ...
                <form class="needs-validation" novalidate method="POST" action="/event/{{$event->id}}/session/{{$session->id}}">
                    @csrf
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-4 mb-3">
                            ...
                            <input type="text" class="form-control {{$errors->has('title') ? 'is-invalid' : ''}}" id="inputTitle" name="title"
                                   placeholder="" value="{{old('title', $session->title)}}" />
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-4 mb-3">
                            ...
                            <input type="text" class="form-control {{$errors->has('speaker') ? 'is-invalid' : ''}}"
                                   id="inputSpeaker" name="speaker" placeholder="" value="{{old('speaker', $session->speaker)}}">
                        ...
                        <div class="col-12 col-lg-4 mb-3">
                            ...
                            <select class="form-control {{$errors->has('room') ? 'is-invalid' : ''}}" id="selectRoom" name="room">
                                @foreach($rooms as $room)
                                    <option value="{{$room->id}}" {{ old('room', $session->room_id) == $room->id ? 'selected' : '' }}>{{$room->name}} / {{$room->channel->name}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-4 mb-3">
                            ...
                            <input type="number" class="form-control {{$errors->has('cost') ? 'is-invalid' : ''}}"
                                   id="inputCost" name="cost" placeholder="" value="{{old('cost', 0) ?? '0'}}">
